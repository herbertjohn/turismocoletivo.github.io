      ...
      <div class="container">
        <div class="row justify-content-center mb-5 element-animate">
          <div class="col-md-7 text-center section-heading">
            <h2 class="text-primary heading">Passeios para turismo de aventura</h2>
        ...
        <div class="nonloop-block-11 owl-carousel">
          ...
          <div class="item">
            <div class="block-19">
              ...
              <div class="text">
                <h2 class="heading"><a href="destinos\vale-do-rio-claro.php">Vale do Rio Claro - Crista do Galo e poço das Antas</a></h2>
          ...
          <div class="item">
            <div class="block-19">
              ...
              <div class="text">
                <h2 class="heading"><a href="destinos\cidade-de-pedra.php">Cidade de pedra</a></h2>
