        ...
        <div class="row align-items-center justify-content-center site-hero-sm-inner">
          <div class="col-md-7 text-center">
            ...
            <div class="mb-5 element-animate">
              <h1 class="mb-2">Circuito das cavernas: Aroejari, Kiogobrado, Lagoa Azul... </h1>
              <p class="bcrumb"><a href="index.php">Início</a> <span class="sep ion-android-arrow-dropright px-2"></span> <a href="destinos.php">Destinos</a> <span class="sep ion-android-arrow-dropright px-2"></span>  <span class="current">Circuito das Cavernas</span></p>
            </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 element-animate">
          <div class="col-md-7 text-left section-heading">
            <h2 class="text-primary heading">Destinos na região</h2>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid block-11 element-animate">
        <div class="nonloop-block-11 owl-carousel">
          <div class="item">
            <div class="block-19">
                <figure>
                  <img src="images/águas do cerrado.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="text">
          ...
          <div class="item">
            <div class="block-19">
                <figure>
                  <img src="images/caminho das águas.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="text">
          ...
          <div class="item">
            <div class="block-19">
              <figure>
                <img src="images/morro de são jerônimo.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="text">
          ...
          <div class="item">
            <div class="block-19">
                ...
                <div class="text">
                  <h2 class="heading"><a href="destinos\Vale-da-Lua.php">Vale da lua</a></h2>
          ...
          <div class="item">
            <div class="block-19">
              <figure>
                <img src="images/cidade de pedra.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="text">
          ...
          <div class="item">
            <div class="block-19">
              <figure>
                <img src="images/Sítio Arqueológico Santa Elina.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="text">
