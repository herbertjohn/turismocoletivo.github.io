        ...
        <div class="row align-items-center justify-content-center site-hero-sm-inner">
          <div class="col-md-7 text-center">
            ...
            <div class="mb-5 element-animate">
              <h1 class="mb-2">Circuito de cachoeiras Caminho das Águas </h1>
              <p class="bcrumb"><a href="../index.php">Início</a> <span class="sep ion-android-arrow-dropright px-2"></span> <a href="../destinos.php">Destinos</a> <span class="sep ion-android-arrow-dropright px-2"></span>  <span class="current">Caminho das Águas</span></p>
            </div>
