        ...
        <div class="row align-items-center justify-content-center site-hero-sm-inner">
          <div class="col-md-7 text-center">
            ...
            <div class="mb-5 element-animate">
              <h1 class="mb-2">Sítio Arqueológico Santa Elina - Jangada</h1>
              <p class="bcrumb"><a href="../index.php">Início</a> <span class="sep ion-android-arrow-dropright px-2"></span> <a href="../destinos.php">Destinos</a> <span class="sep ion-android-arrow-dropright px-2"></span>  <span class="current">Sítio Arquieológico Santa Elina</span></p>
            </div>
...
Término da trilha: Por volta das 16h</p>
          ...
          <div class="col-md-6 col-lg-4 order-md-1">
            ...
            <div class="block-28 text-center mb-5">
              <figure>
                 <img src="../images/logo turismo coletivo.png" alt="" class="img-fluid">
              </figure>
