      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
            <h3><a href="../index.php">Turismo Coletivo</a></h3>
          ...
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
            <h3 class="heading"><a href="../blog.php">Blog</h3>
            <div class="block-21 d-flex mb-4">
              <div class="text">
                <h3 class="heading mb-0"><a href="../news.php">Cascata do Uirapuru ameaçada por hidrelétrica.</a></h3>
                <div class="meta">
...
Copyright &copy; Todos os direitos reservados |<a href="index.php">Turismo Coletivo</a>
              </p>
